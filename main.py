...
# 🚀 FIX: CrewAI ka 20 second wala prompt hamesha ke liye band
...
def ask_agent(request: UserRequest, db: Session = Depends(get_db)):
    ...
    2. Update Persona ONLY for stylistic preferences (e.g. "short answers").
    ...
    Task:
    1. CATEGORIZE the topic (e.g. gaming, coding, news).
    2. EFFECTIVE QUERY: If the query is short, rewrite it into a full question.
    3. INSTRUCTIONS: Strict rules for Worker AI.
    ...
    for i in range(45):
        try:
            ...
            backstory_text = (
                f"You are a highly capable AI expert. Today is {current_time_str}. "
                f"NAME: Use '{request.user_name}'. NO NARRATION. "
            ...
            smart_agent = Agent(
                ...
                goal='Answer directly without narrating.',
